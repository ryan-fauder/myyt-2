...
class Servidor:
    def handle(self, request: Mensagem) -> Mensagem:
        # Lógica do servidor para processar a requisição
        # Aqui você deve implementar a lógica específica do seu servidor
        # e retornar uma resposta adequada.
        print(f"Servidor recebeu uma requisição do tipo {request.tipo}")
        
        # Exemplo: criando uma resposta com o mesmo tipo e dados invertidos
        response = Mensagem(request.tipo, request.dado[::-1], request.tipo_dado, request.tamanho_dado)
